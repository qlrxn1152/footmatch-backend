...
public class TeamJoinRequestCancelResponse {
    ...
    public static TeamJoinRequestCancelResponse of(TeamJoinRequest teamJoinRequest) {
        return new TeamJoinRequestCancelResponse(
