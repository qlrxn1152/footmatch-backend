    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/team-matches/pending", "/api/team-matches/matched").permitAll() // 전체 팀의 PENDING, MATCHED 매치들 조회는 모든유저가 가능
                        .requestMatchers(HttpMethod.GET, "/api/teams/{teamId}/matches/pending", "/api/teams/{teamId}/matches/matched").permitAll() // 특정 팀의 PENDING, MATCHED 매치들 조회는 누구나 가능
